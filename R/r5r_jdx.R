...
### Install r5r 0.6-0 from GitHub master branch
...
# save results ------------------------------------------------------------
write_csv(computing_times_df, here::here("data/jdx", "computing_times.csv"))
write_csv(ttm, here::here("data/jdx", "travel_time_matrix.csv"))
write_csv(access, here::here("data/jdx", "accessibility.csv"))
write_csv(dit, here::here("data/jdx", "detailed_itineraries.csv"))

write_csv(street_net$vertices, here::here("data/jdx", "street_vertices.csv"))
write_csv(street_net$edges, here::here("data/jdx", "street_edges.csv"))

write_csv(transit_net$stops, here::here("data/jdx", "transit_stops.csv"))
write_csv(transit_net$routes, here::here("data/jdx", "transit_routes.csv"))

write_csv(snap, here::here("data/jdx", "snap.csv"))
